...
import { Search, MapPin, Phone, Utensils, MessageCircle, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-50">
      ...
      <section className="bg-gradient-to-br from-red-600 to-red-800 py-14 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-display font-bold text-white mb-3 flex items-center justify-center gap-3"><Utensils size={34} /> Restaurants en Guinée</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        {isLoading ? (
          ...
          <div className="card p-16 text-center col-span-3">
            <Utensils size={52} className="text-dark-300 mx-auto mb-4" />
              ...
              <div key={r.id} className="card group overflow-hidden">
                <div className="aspect-video bg-red-50 overflow-hidden relative">
                  {r.images?.[0]?.url
                    ...
                    : <div className="w-full h-full flex items-center justify-center"><Utensils size={52} className="text-red-200" /></div>}
                ...
                <div className="p-5">
                  ...
                  {r.schedule && <p className="text-dark-400 text-xs mb-4 flex items-center gap-1"><Clock size={11} /> {r.schedule}</p>}
                  <div className="flex gap-2">
                    ...
                    {r.whatsapp && <a href={`https://wa.me/224${r.whatsapp}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-green-500 rounded-xl flex items-center justify-center hover:bg-green-600 transition-colors text-white"><MessageCircle size={16} /></a>}
                  </div>
                </div>
              </div>
            ))}
