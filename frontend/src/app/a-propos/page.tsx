    ...
    <div className="min-h-screen bg-dark-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
          {[
            { icon: '🇬🇳', title: 'Made in Guinée', desc: 'Conçu spécialement pour les Guinéens, par des Guinéens.' },
            { icon: '🔒', title: 'Sécurisé', desc: 'Vos données sont protégées. Chaque annonce est vérifiée.' },
            { icon: '⚡', title: 'Rapide & Moderne', desc: 'Interface moderne disponible sur tous vos appareils.' },
          ].map((item, i) => (
