...
function ConfirmerEmailContent() {
  const t = useTranslations('auth.confirmerEmail');
        ...
        <div className="w-full max-w-md">
          ...
          {status === 'success' && (
            <div className="text-center">
              ...
              >
                {isAuthenticated ? t('backToSettings') : t('login')}
              </Link>
            </div>
          )}
          ...
          {status === 'error' && (
            <div className="text-center">
              ...
              <h2 className="font-display font-bold text-2xl text-dark-900 mb-3">{t('errorTitle')}</h2>
              <p className="text-dark-500 text-sm mb-6 leading-relaxed">{message}</p>
